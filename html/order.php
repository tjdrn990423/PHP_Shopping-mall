...
<?
   ///주문자정보를 위한 변수 초기화 ($o_no="0"; $o_name=""; … ).
                  ...
                  <table width="560" border="0" cellpadding="0" cellspacing="0" class="cmfont">
                     ...
                     <tr height="50">
                        ...
                        <td width="390">
                           ...
                           <input type="text" name="o_juso" size="47" maxlength="200" value="<?=$o_juso;?>" class="cmfont1"><br>
                        </td>
                     </tr>
                  </table>
                  ...
                  <table width="560" border="0" cellpadding="0" cellspacing="0" class="cmfont">
                     ...
                     <tr height="50">
                        ...
                        <td width="390">
                           ...
                           <input type="text" name="r_juso" size="47" maxlength="200" value="" class="cmfont1"><br>
                        </td>
                     </tr>
                     <tr height="50">
