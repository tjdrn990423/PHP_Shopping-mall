...
<?
   ...
   $k=0;
   if($sel1 != 0){$s[$k] = " state47=" . $sel1; $k++;}
   if($text1){
      if($sel2==0){$s[$k] = " no47 like '%".$text1."%'"; $k++;}
      else if($sel2==1){$s[$k] = " o_name47 like '%".$text1."%'"; $k++;}
      else if($sel2==2){$s[$k] = " product_names47 like '%".$text1."%'"; $k++;}
   }
   if($day1_y && $day1_m && $day1_d){$s[$k] = " jumunday47>='$day1'"; $k++;}
   if($day2_y && $day2_m && $day2_d){$s[$k] = " jumunday47<='$day2'"; $k++;}
   if($k>0)
   {
      $tmp=implode(" and",$s);
      $tmp="where" . $tmp;
...
<form name="form1" method="post" action="jumun.php?day1_y=<?=$day1_y?>&day1_m=<?=$day1_m?>&day1_d=<?=$day1_d?>
&day2_y=<?=$day2_y?>&day2_m=<?=$day2_m?>&day2_d=<?=$day2_d?>&sel1=<?=$sel1?>&sel2=<?=$sel2?>&text1=<?=$text1?>&page=<?=$page?>">
...
<table width="800" border="1" cellpadding="0" style="border-collapse:collapse">
  ...
  <?
   ...
   for($i=0; $i<$page_last;$i++)
   {
      ...
      if($row[pay_method47]==0) $pay_method47="카드"; else $pay_method47="통장";
      $p=number_format($row[total_cash47]);
      $state=$row[state47];
     echo("<tr bgcolor='#F2F2F2' height='23'>   
         <td width='70' align='center'><a href='jumun_info.php?no=$row[no47]&day1_y=$day1_y&day1_m=$day1_m&day1_d=$day1_d&day2_y=$day2_y&day2_m=$day2_m&day2_d=$day2_d&sel1=$sel1&sel2=$sel2&text1=$text1&page=$page''>$row[no47]</a></td>
         <td width='70' align='center'>$row[jumunday47]</td>
         <td width='250' align='left'>&nbsp $row[product_names47]</td>   
         <td width='47'  align='center'>$row[product_nums47]</td>   
         <td width='70'  align='right'>$p&nbsp</td>   
         <td width='65' align='center'>$row[o_name47]</td>
         <td width='50' align='center'>$pay_method47</td>
         ...
         <?echo("
         <td width='50'  align='center'>
         <a href='jumun_delete.php?no=$row[no47]&day1_y=$day1_y&day1_m=$day1_m&day1_d=$day1_d&day2_y=$day2_y&day2_m=$day2_m&day2_d=$day2_d&sel1=$sel1&sel2=$sel2&text1=$text1&page=$page' ");?> onclick="javascript:return confirm('삭제할까요 ?');"><?echo("<img src='images/b_delete1.gif' border='0'></a>
         </td>
     </tr>");
   }
